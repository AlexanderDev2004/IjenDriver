    ...
    <div class="max-w-md mx-auto mt-12 bg-white rounded-lg shadow-lg p-8">
        ...
        <form method="POST" action="{{ route('postlogin') }}">
            ...
            <input type="text" name="email" required
                class="w-full px-3 py-2 mb-1 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-400"
            ...
            <button type="submit"
                class="w-full py-2 bg-blue-600 hover:bg-blue-700 text-white rounded font-semibold text-lg transition">Login</button>
        </form>
    </div>
</body>
